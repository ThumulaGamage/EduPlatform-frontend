...
import { User, Mail, MapPin, Calendar, Edit, BookOpen, Trophy, Clock } from "lucide-react";
...
const StudentProfile = () => {
  ...
  const totalProgress = approvedEnrollments.length > 0
            ...
            <CardHeader className="relative">
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <Badge className="mb-4" variant="secondary">Student</Badge>
              ...
              {loading ? (
                ...
                <div className="space-y-4">
                  {approvedEnrollments.map((enrollment) => (
                    ...
                    >
                      <div className="flex-1">
                        <h4 className="font-semibold">{enrollment.courseId.title}</h4>
